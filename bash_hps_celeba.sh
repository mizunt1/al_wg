...
python uq_tests.py --minority_prop 0.1 --data_mode celeba_non_sp --lr ${LR[$LR_IDX]}  --batch_size ${BATCH[$BATCH_IDX]} --num_epochs 100 --save_dir results --project_name clip_hps_celeba_non_sp --model_name BayesianNetClip --mc_drop_p ${DROP_OUT[$DROP_IDX]}
