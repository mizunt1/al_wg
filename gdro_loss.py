...
class LossComputer:
    def __init__(self, criterion, is_robust, dataset, n_groups, alpha=None, gamma=0.1, adj=None, min_var_weight=0, step_size=0.01, normalize_loss=False, btl=False):
    ...
    def compute_group_avg(self, losses, group_idx):
        ...
        group_map = (group_idx.cuda() == torch.arange(self.n_groups).unsqueeze(1).long().cuda()).float()
